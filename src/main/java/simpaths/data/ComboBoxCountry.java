...
public class ComboBoxCountry extends JPanel implements ActionListener {
	...
	//	numCountries = 1; //Overrides the above to only allow selection of Italy
		...
		countryList.setSelectedIndex(Country.HU.ordinal());
	...
	protected void updateLabel(String countryName) {
		Country country = Country.HU.getCountryFromNameString(countryName);
	 ...
	 *
	 */
	public Country getCountryEnum() { return Country.HU.getCountryFromNameString(this.countryName); }
}
